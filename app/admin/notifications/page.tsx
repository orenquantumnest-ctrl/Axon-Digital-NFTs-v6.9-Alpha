...
const NOTIFICATIONS = [
  {
    ...
    message: "V7 Sovereign Core deployment commencing at 03:00 UTC.",
    type: "system",
    status: "scheduled",
    time: "In 2 hours",
  },
  {
    id: "2",
    title: "High Deposit Volume",
    message: "USDT deposits are currently 300% above daily average.",
    type: "alert",
    status: "active",
    time: "10 mins ago",
  },
  {
    ...
    message:
      '"New Elite Staking Pack Available" broadcast sent to 1,240 users.',
    type: "broadcast",
    status: "completed",
    time: "1 day ago",
  },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Push to all active sessions immediately.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 mt-2">
              <label className="flex items-center gap-2 text-sm text-slate-400 cursor-pointer">
                <input
                  type="checkbox"
                  className="accent-[#00FFB2] w-4 h-4 cursor-pointer"
                />{" "}
                Mobile Push
              </label>
              <label className="flex items-center gap-2 text-sm text-slate-400 cursor-pointer">
        ...
        <div className="lg:col-span-7 bg-[#121212]/60 backdrop-blur-xl border border-white/5 rounded-3xl p-6">
          <div className="flex items-center justify-between mb-6 pb-4 border-b border-white/5">
            <div>
              <h3 className="text-lg font-bold text-white">
                System Signal History
              </h3>
              <p className="text-xs text-slate-400">
                Recent broadcasts and automatic system alerts.
              </p>
            </div>
            <button className="text-xs text-slate-400 hover:text-white uppercase font-bold tracking-widest">
              Mark All Read
            </button>
          </div>
          ...
          <div className="space-y-4">
            {NOTIFICATIONS.map((notification) => (
              <div
                key={notification.id}
                className="p-4 rounded-2xl bg-[#0A0A0A] border border-white/5 flex gap-4"
              >
                <div className="mt-1">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={`text-[10px] uppercase font-bold tracking-widest px-2 py-0.5 rounded-md border

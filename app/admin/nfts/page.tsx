                  ...
                  <tr key={nft.id} className="hover:bg-white/[0.02] transition-colors" role="row">
                    ...
                    <td className="px-6 py-4" role="gridcell">
                      <div className="flex items-center gap-3">
                        <div className="w-11 h-11 rounded-xl overflow-hidden self-center border border-white/5 flex-shrink-0 relative">
                          {/* LAZY IMAGE LOADER UTILIZED */}
                          <LazyNFTImage src={nft.image_url} alt={nft.name || "NFT Item"} className="w-full h-full" />
                        </div>
                        <div>
